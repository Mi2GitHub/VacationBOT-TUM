...
export default function HomePage() {
    return <div>
        <p>Hallo, <br/>
            danke, dass du mich bei dem Projekt meiner Masterarbeit unterstützt. Hierdurch hilfst du dabei, dass KI-Entwickler bessere und nutzerzentriertere KI-Anwendungen entwickeln können. <br/>
